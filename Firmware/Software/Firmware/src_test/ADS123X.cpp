...
String ADS123X::printErroer(ERROR_t error){
  switch (error)
  {
  case ERROR_t::NoERROR:
    return "NoERROR";
    break;
  case ERROR_t::DIVIDED_by_ZERO:
    return "DIVIDED_by_ZERO";
    break;
  case ERROR_t::STABLE_TIMEOUT:
    return "STABLE_TIMEOUT";
    break;
  case ERROR_t::TIMEOUT_HIGH:
    return "TIMEOUT_HIGH";
    break;
  case ERROR_t::TIMEOUT_LOW:
    return "TIMEOUT_LOW";
    break;
